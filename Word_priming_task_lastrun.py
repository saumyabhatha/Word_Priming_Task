...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='D:\\AU\\PSY310\\Word_priming_task\\Word_priming_task_lastrun.py',
...
trials = data.TrialHandler(nReps=1.0, method='random', 
    ...
    trialList=data.importConditions('D:/AU/PSY310/Word_priming_task/study_words.xlsx'),
...
trials_2 = data.TrialHandler(nReps=1.0, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('D:/AU/PSY310/Word_priming_task/test.xlsx'),
